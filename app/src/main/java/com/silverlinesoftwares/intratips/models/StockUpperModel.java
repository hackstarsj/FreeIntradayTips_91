...
public class StockUpperModel implements Serializable {
    String ptsC;
    String wklo;
    ...
    public StockUpperModel(String ptsC, String wklo, String iislPtsChange, String symbol, String cAct, String mPC, String wkhi, String wklocm_adj, String trdVolM, String wkhicm_adj, String mVal, String ltP, String xDt, String trdVol, String ntP, String yPC, String previousClose, String dayEndClose, String high, String iislPercChange, String low, String per, String open) {
        this.ptsC = ptsC;
        this.wklo = wklo;
