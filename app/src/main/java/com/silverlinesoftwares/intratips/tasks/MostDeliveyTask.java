...
public class MostDeliveyTask extends AsyncTask<String,String ,String > {


    ChartListener chartListener;
    public MostDeliveyTask(ChartListener chartListener) {
    ...
    protected String doInBackground(String... strings) {
        ...
        Request request =
                new Request.Builder()
                        .url("https://www1.nseindia.com/archives/equities/mto/MTO_05072019.DAT")
