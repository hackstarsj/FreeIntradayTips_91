...
public class ScreenTask4c extends AsyncTask<String ,String,String> {
    ...
    public ScreenTask4c(Context context,String  url,TableLayout layout,ProgressBar progressBar){
    ...
    private void BuildHeader(String s) {
        final String regex = "<thead><tr><th>(.*?)<\\/tr><\\/thead>";
    ...
    private void BuildHeader2(String group) {
        ...
        while (matcher.find()) {
            ...
            for (int i = 1; i <= matcher.groupCount(); i++) {
                ...
                if(android.text.Html.fromHtml(il).toString().contains("Patterns")){
                    continue;
                }
                ...
                if(tl!=null) {
                    ...
                    if (items.length >= columns_size) {
                        ...
                        for (String item : items) {
                            ...
                            if(android.text.Html.fromHtml(item).toString().contains("Patterns")){
                                continue;
                            }
