...
public class BlockDealTask extends AsyncTask<String,String ,String > {
    ...
    protected String doInBackground(String... strings) {
        ...
        Request request =
                new Request.Builder()
                        .url("https://www1.nseindia.com/products/dynaContent/equities/equities/blockdeals.jsp?symbol=&segmentLink=12&symbolCount=&dateRange=15days&fromDate=&toDate=&dataType=BLOCK")
