...
public class OiSpurtsTask extends AsyncTask<String ,String ,JSONObject> {
    ...
    protected JSONObject doInBackground(String... strings) {
        ...
        try {
            jsonObject.put("data_1",getVolume);
            jsonObject.put("data_2",getValues);
            return jsonObject;
    ...
    private JSONObject getValues() {
        ...
        String url="https://www1.nseindia.com/live_market/dynaContent/live_analysis/oi_spurts/topPositiveOIChangeData.json";
    ...
    private JSONObject getVolume() {
        ...
        String url="https://www1.nseindia.com/live_market/dynaContent/live_analysis/oi_spurts/riseInPriceRiseInOI.json";
