...
public class VolumeTask extends AsyncTask<String,String ,String > {
    ...
    protected String doInBackground(String... strings) {
        ...
        Request request =
                new Request.Builder()
                        .url("https://www.nseindia.com/products/dynaContent/common/productsSymbolMapping.jsp?symbol="+strings[0].replace(".NS","").replace(".BO","")+"&segmentLink=3&symbolCount=1&series=ALL&dateRange="+strings[1]+"&fromDate=&toDate=&dataType=PRICEVOLUMEDELIVERABLE")
                        .addHeader("User-Agent","Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:67.0) Gecko/20100101 Firefox/67.0")
                        .addHeader("Referer","https://www.nseindia.com/products/content/equities/equities/eq_security.htm")
