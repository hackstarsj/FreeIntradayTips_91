...
public class ResetPasswordNextTask extends AsyncTask<String ,String ,String > {

    private ApiResponseListener apiResponseListener;
    public ResetPasswordNextTask(ApiResponseListener apiResponseListener){
    ...
    protected String doInBackground(String... strings) {
        ...
        Request request =
                new Request.Builder()
                        .url("https://furthergrow.silverlinesoftwares.com/login/verify_password_code")
                        .post(requestBody)
                        .build();
