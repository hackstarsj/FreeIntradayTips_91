...
public class McxDataTask extends AsyncTask<String,String,String > {
    ...
    public McxDataTask(Context context, OptionAdapter equityAdapter, List<Object> equityModels, UserModel userModel, String token, RecyclerView recyclerView, Button button) {
