...
public class OptionDataTask extends AsyncTask<String,String,String > {
    ...
    public OptionDataTask(Context context, OptionAdapter equityAdapter, List<Object> equityModels,UserModel userModel,String token,RecyclerView recyclerView,Button button) {
    ...
    protected String doInBackground(String... strings) {
        ...
        Request request =
                new Request.Builder()
                        .url("https://furthergrow.silverlinesoftwares.com/intra_option.php")
                        .post(requestBody)
                        .build();
