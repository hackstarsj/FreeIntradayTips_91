...
public class SingleTask26 extends AsyncTask<String ,String,String> {
    ...
    public SingleTask26(Context context,String  url,TableLayout layout,ProgressBar progressBar){
