...
public class ScreenTask4b extends AsyncTask<String ,String,String> {
    ...
    public ScreenTask4b(Context context,String  url,TableLayout layout,ProgressBar progressBar){
