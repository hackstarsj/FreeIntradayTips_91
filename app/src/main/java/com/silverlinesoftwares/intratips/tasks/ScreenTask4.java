...
public class ScreenTask4 extends AsyncTask<String ,String,String> {
    ...
    public ScreenTask4(Context context,String  url,TableLayout layout,ProgressBar progressBar){
