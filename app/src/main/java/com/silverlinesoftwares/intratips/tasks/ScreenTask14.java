...
public class ScreenTask14 extends AsyncTask<String ,String,String> {
    ...
    public ScreenTask14(Context context,String  url,TableLayout layout,ProgressBar progressBar){
