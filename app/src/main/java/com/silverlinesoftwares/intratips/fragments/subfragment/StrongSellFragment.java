...
public class StrongSellFragment extends Fragment implements NetworkRequestListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        NetworkRequestLoaderRaw.LoadData(getContext(),"https://scanner.tradingview.com/india/scan",map , StrongSellFragment.this, Request.Method.POST, StaticMethods.getStrongSellPost(),"");
    }
    ...
    public void onCompletedLoading(String data, String from) {
        ...
        List<StrongBuySellModel> strongBuySellModels=StaticMethods.getBuySellModel(data,true);
