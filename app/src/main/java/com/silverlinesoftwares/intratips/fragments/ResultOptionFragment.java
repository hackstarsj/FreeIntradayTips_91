...
import com.silverlinesoftwares.intratips.adapters.ResultOptionAdapter;
...
import com.silverlinesoftwares.intratips.tasks.ResultOptionTask;
...
public class ResultOptionFragment extends Fragment  implements ResultListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ResultOptionTask resultTask=new ResultOptionTask(ResultOptionFragment.this);
        resultTask.execute();
    ...
    public void onSucess(List<ResultModel> data) {
        ...
        if(mContext != null) {
            ResultOptionAdapter resultAdapter = new ResultOptionAdapter(mContext, data);
