...
public class MoverLooserFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        griditems.setOnItemClickListener((parent, view1, position, id) -> startActivity(new Intent(getContext(), LooserGainerActivity.class).putExtra(Constant.data_title,moverLooserMenus.get(position).getName()).putExtra(Constant.data_text,moverLooserMenus.get(position).getData_text())));
