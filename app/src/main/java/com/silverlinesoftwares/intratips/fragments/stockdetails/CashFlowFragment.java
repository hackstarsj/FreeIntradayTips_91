...
import com.silverlinesoftwares.intratips.tasks.CahsFlowTask;
import com.silverlinesoftwares.intratips.util.Constant;

import java.util.List;


public class CashFlowFragment extends Fragment implements IncomeStateListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        CahsFlowTask financialTask=new CahsFlowTask(CashFlowFragment.this);
