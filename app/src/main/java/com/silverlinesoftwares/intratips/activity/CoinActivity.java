...
import com.silverlinesoftwares.intratips.adapters.CoinAdapter;
...
import com.silverlinesoftwares.intratips.tasks.CoinTask;
...
public class CoinActivity extends AppCompatActivity implements ChartListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(CoinActivity.this, initializationStatus -> {

        });
        progress=findViewById(R.id.progress);
        listView=findViewById(R.id.list_volume_gainer);
        CoinTask gainerLooserTask=new CoinTask(CoinActivity.this);
        gainerLooserTask.execute();

        View adContainer2 = findViewById(R.id.adView2);
        StaticMethods.showBannerAds(adContainer2,CoinActivity.this);
        showInterestialAds();
    ...
    public void onSucess(String data) {
        ...
        CoinAdapter bulkDealAdapter=new CoinAdapter(CoinActivity.this,bulkModels);
    ...
    public void onFailed(String msg) {
        progress.setVisibility(View.GONE);
        Toast.makeText(CoinActivity.this, msg, Toast.LENGTH_SHORT).show();
    }
}
