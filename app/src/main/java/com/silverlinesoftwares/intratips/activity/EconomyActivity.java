...
import com.silverlinesoftwares.intratips.tasks.EconomyTask;
...
public class EconomyActivity extends AppCompatActivity implements ChartListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(EconomyActivity.this,getString(R.string.app_ads_id));
    ...
    private void LoadHomePage(){
        ...
        for (int i=0;i<titles.length;i++) {
            ...
            EconomyFragment managementFragment = new EconomyFragment();
...
//                    "} " +
        ...
        String all_data2 = "<html><head> <title></title>" +
                "<style> " +
                "body{ margin:0px;padding:0px; } " +
                "th{ background:dodgerblue;color:white; } " +
                "table,td,th{ border:1px solid black;border-collapse:collapse;white-space: nowrap; }" +
    ...
    public void onFailed(String msg) {
        progressBar.setVisibility(View.GONE);
        Toast.makeText(EconomyActivity.this, ""+msg, Toast.LENGTH_SHORT).show();
    }
}
