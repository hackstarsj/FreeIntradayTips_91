...
public class MajorHolderAdapterR extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MajorHolderAdapterR(Context context, RecyclerView view, List<MajorHolderModel> items) {
        this.items = items;
        ctx = context;
    }
