...
public class DeliveryFragment extends Fragment implements AccountOpenClick {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        OptionAdapter equityAdapter = new OptionAdapter(listView, currentequityModels, getActivity(), getActivity(), DeliveryFragment.this);
        listView.setAdapter(equityAdapter);
        pro_plus_btn.setVisibility(View.GONE);
        listView.setVisibility(View.VISIBLE);
        DeliveryDataTask equityTask = new DeliveryDataTask(getContext(), equityAdapter, currentequityModels, listView, pro_plus_btn);
        equityTask.execute();
